...
if strcmp(user, 'tom')
  ...
  sourceDescr = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'descriptor');
  % Primes.
  sourceCsv = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'prime_csv');
  destWav = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'prime_wav');
  csv2wav(sourceCsv, destWav, sourceDescr, sourceWav, instrNam, Fs, fadeOut);
  % True continuations.
  sourceCsv = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'cont_true_csv');
  destWav = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'cont_true_wav');
  csv2wav(sourceCsv, destWav, sourceDescr, sourceWav, instrNam, Fs, fadeOut);
  % Foil continuations.
  sourceCsv = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'cont_foil_csv');
  destWav = fullfile(basePath, '20180725', 'PPDD-Jul2018', 'audio',...
    'polyphonic', 'medium', 'cont_foil_wav');
  csv2wav(sourceCsv, destWav, sourceDescr, sourceWav, instrNam, Fs, fadeOut);
